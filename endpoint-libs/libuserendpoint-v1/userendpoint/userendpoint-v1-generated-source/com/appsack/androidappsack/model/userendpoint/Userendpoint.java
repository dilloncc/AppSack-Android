...
package com.appsack.androidappsack.model.userendpoint;
...
public class Userendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetCurrentUser extends UserendpointRequest<com.appsack.androidappsack.model.userendpoint.model.User> {
    ...
    protected GetCurrentUser(java.lang.String apiKey) {
      super(Userendpoint.this, "GET", REST_PATH, null, com.appsack.androidappsack.model.userendpoint.model.User.class);
  ...
  public class InsertNewUser extends UserendpointRequest<com.appsack.androidappsack.model.userendpoint.model.AuthResponse> {
    ...
    protected InsertNewUser(java.lang.String email, java.lang.String password, java.lang.String firstName, java.lang.String lastName, java.lang.String displayName) {
      super(Userendpoint.this, "POST", REST_PATH, null, com.appsack.androidappsack.model.userendpoint.model.AuthResponse.class);
   ...
   *
   * @param content the {@link com.appsack.androidappsack.model.userendpoint.model.User}
   * @return the request
   */
  public InsertUser insertUser(com.appsack.androidappsack.model.userendpoint.model.User content) throws java.io.IOException {
    InsertUser result = new InsertUser(content);
    initialize(result);
    return result;
  }

  public class InsertUser extends UserendpointRequest<com.appsack.androidappsack.model.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected InsertUser(com.appsack.androidappsack.model.userendpoint.model.User content) {
      super(Userendpoint.this, "POST", REST_PATH, content, com.appsack.androidappsack.model.userendpoint.model.User.class);
    }
  ...
  public class ListUser extends UserendpointRequest<com.appsack.androidappsack.model.userendpoint.model.CollectionResponseUser> {
     ...
     */
    protected ListUser() {
      super(Userendpoint.this, "GET", REST_PATH, null, com.appsack.androidappsack.model.userendpoint.model.CollectionResponseUser.class);
    }
  ...
  public class LogInUser extends UserendpointRequest<com.appsack.androidappsack.model.userendpoint.model.AuthResponse> {
   ...
   * @return the request
   */
  public UpdateUser updateUser(com.appsack.androidappsack.model.userendpoint.model.User content) throws java.io.IOException {
    UpdateUser result = new UpdateUser(content);
    initialize(result);
    return result;
  }

  public class UpdateUser extends UserendpointRequest<com.appsack.androidappsack.model.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected UpdateUser(com.appsack.androidappsack.model.userendpoint.model.User content) {
      super(Userendpoint.this, "PUT", REST_PATH, content, com.appsack.androidappsack.model.userendpoint.model.User.class);
    }
